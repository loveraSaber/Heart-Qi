...
class Detector(object):
    ...
    def detect_identity(self, frame, facebox, **identity_model_kwargs):
        ...
        face_embeddings = face_embeddings.detach().cpu().numpy()
        return self._convert_detector_output(facebox, face_embeddings)
