...
from pyfeat.utils.video_util import rotate_video
from pyfeat.utils.analyze import emotion_tendency_pipeline
from config.env import FeatConfig
from module.entity.response_entity import ResponseEntity
from config.env import AnalysisConfig
import warnings
import time
...
class EmotionDetector():
    ...
    def detect_video(self, input_path, output_path, skip_frames=10, num_workers=4, batch_size=32):
