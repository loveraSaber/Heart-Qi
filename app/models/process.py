...
def process_video(video_path, detector, processor, model, device, batch_size=64, output_path="output_faces.mp4", alpha=0.7, window_size=5, face_size=(224,224)):
        ...
        while True:
            ...
            if len(frames_rgb) == batch_size:
                ...
                for frm, result in zip(frames_bgr, results):
                    ...
                    pil_image = Image.fromarray(face_aligned)
